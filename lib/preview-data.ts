...
export const PREVIEW_ENTITIES: PreviewEntity[] = [
  ...
  E("spa-crossfit", "Crossfit (partner)", "spa"),
  ...
  E("vintage-awoke-vintage", "Awoke Vintage", "vintage", "Williamsburg"),
  E("vintage-raggedy-threads", "Raggedy Threads", "vintage", "Nolita"),
  E("vintage-friends-nyc", "Friends NYC", "vintage", "Williamsburg"),
  E("vintage-opc-other-people-s-clothes", "OPC (Other People's Clothes)", "vintage", "Bushwick"),
  E("vintage-monk-vintage", "Monk Vintage", "vintage", "Williamsburg"),
  E("vintage-grand-street-local", "Grand Street Local", "vintage", "Williamsburg"),
  E("event-nyc-drag-march", "NYC Drag March", "event", "East Village"),
  E("show-joes-pub", "Joe's Pub", "show", "NoHo"),
...
export const PREVIEW_INSTANCES: PreviewInstance[] = [
  ...
  { slotId: "sun21-crossfit", entityId: "spa-crossfit", capacity: "planB", note: "Partner maybe (MOS). Which gym TBD." },
  ...
  { slotId: "fri26-vintage", entityId: "vintage-procell", capacity: "confirmed", note: "Pick of the day — pair with another if time." },
  { slotId: "fri26-vintage", entityId: "vintage-desert-vintage", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-awoke-vintage", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-raggedy-threads", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-friends-nyc", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-opc-other-people-s-clothes", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-monk-vintage", capacity: "planB" },
  { slotId: "fri26-vintage", entityId: "vintage-grand-street-local", capacity: "planB" },
